...
knitr::include_graphics("OverdoseRatesNYCCommunityDistrict.png")
```
```
...
knitr::include_graphics("RatesOfOverdoseBronx.png")
```
...
knitr::include_graphics("StatenIslandHotspot.png")
```
...
knitr::include_graphics("ComparingDrugandOverdose.png")
```
```{r}
#| echo: false
#| fig-cap: "Drug arrest patterns by community district."

knitr::include_graphics("DrugArrestByCommunityDistrict.png")
```
...
knitr::include_graphics("HarlemOverdoseHotspot.png")
```
...
knitr::include_graphics("OverdoseDeathsCommunityDistrict.png")
```
